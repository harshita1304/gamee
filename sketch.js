...
startImg=loadImage("pictures/start.gif");
dragonImg=loadAnimation("pictures/dragon-unscreen.gif");
warriorImg=loadImage("warrior.jpeg");
...
if(gameState==="play"){
    ...
    if(enemyGroup.collide(a)||enemyPt2Group.collide(a)||enemyPt3Group.collide(a)){
        life=life-1;
        console.log("hello");
    }
...
if(gameState==="Level 3"){
    ...
    bg.addImage("background",background2);
    bg.changeImage("background",background2);
    bg.scale=0.5
    soldier.changeImage(warriorImg);
    var dragon=createSprite(windowWidth/2+200,windowHeight/2);
    dragon.addAnimation(dragonImg);
    dragon.velocityX=random(-2,2);
    dragon.velocityY=random(-6,6);
    shield=createSprite(windowWidth/2,windowHeight/2,5,windowHeight);
    shield.visible=false;
    dragon.bounceOff(shield);
